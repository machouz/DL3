...
if __name__ == '__main__':
    ...
    w2i_file = sys.argv[4] if len(sys.argv) > 4 else 'Transducer4_pos_w2i'
    id_label_file = sys.argv[5] if len(sys.argv) > 5 else 'Transducer4_pos_i2l'
    dev_name = sys.argv[6] if len(sys.argv) > 6 else "data/pos/dev"
    wc2i_file = sys.argv[7] if len(sys.argv) > 7 else "Transducer4_pos_wc2i"
