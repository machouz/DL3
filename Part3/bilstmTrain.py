...
if __name__ == '__main__':
    ...
    model_file = sys.argv[3] if len(sys.argv) > 3 else 'Transducer3_ner'
    w2i_file = sys.argv[4] if len(sys.argv) > 4 else 'Transducer3_ner_w2i'
    id_label_file = sys.argv[5] if len(sys.argv) > 5 else 'Transducer3_ner_i2l'
